...
public class EditTest {
    ...
    public void editAdmin() throws InterruptedException {
        Thread.sleep(1000);
        WebElement email, senha, buttonLogin, perfilDropdown, perfilButton,editPerfilButton, newName, newEmail, newPassword, saveChangesButton;
        ...
        try {
            editPerfilButton = driver.findElement(By.xpath("/html/body/div[1]/div/main/div[2]/div/div/div[1]/div/div[1]/div[2]/button[1]"));
        } catch (NoSuchElementException e) {
        ...
        try {
            WebElement successElement = driver.findElement(By.xpath("//html/body/div[1]/div/main/div[2]/div[1]/strong"));
