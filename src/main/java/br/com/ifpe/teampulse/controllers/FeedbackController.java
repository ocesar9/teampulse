...
public class FeedbackController {
    ...
    // Listar feedbacks de um usuário
    ...
    public ResponseEntity<Map<String, Object>> getUserFeedbacks(@PathVariable String userId) {
        ...
        // Verifica se o usuário atual pode visualizar os feedbacks
    ...
    public ResponseEntity<Map<String, Object>> getAllFeedbacks() {
        ...
        if (!isAdmin(currentUser.getUserType())) {
            return buildForbiddenResponse("Apenas administradores podem listar todos os feedbacks");
        }
